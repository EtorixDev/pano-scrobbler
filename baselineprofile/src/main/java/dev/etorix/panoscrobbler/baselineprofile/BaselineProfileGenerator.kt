package dev.etorix.panoscrobbler.baselineprofile

import androidx.benchmark.macro.junit4.BaselineProfileRule
import androidx.test.ext.junit.runners.AndroidJUnit4
import androidx.test.filters.LargeTest
import dev.etorix.panoscrobbler.baselineprofile.Journeys.dismissChangelogDialog
import dev.etorix.panoscrobbler.baselineprofile.Journeys.loginIfNeeded
import dev.etorix.panoscrobbler.baselineprofile.Journeys.switchTabs
...
class BaselineProfileGenerator {
    ...
    fun generate() {
        ...
        rule.collect("dev.etorix.panoscrobbler", includeInStartupProfile = true) {
            ...
            if (firstIteration) {
                device.executeShellCommand("pm clear dev.etorix.panoscrobbler")
