...
[![Download installer for x64 from GitHub](img/github-exe-x64.svg)](https://github.com/EtorixDev/pano-scrobbler/releases/latest/download/pano-scrobbler-etd-windows-x64.exe)
...
[![Download APK from GitHub](img/github-apk.svg)](https://github.com/EtorixDev/pano-scrobbler/releases)
...
- Scrobbling the new Pixel Now Playing app (since the March 2026 Pixel feature drop) is possible only with root and KieronQuinn's Xposed module [Public Compute Services](https://github.com/KieronQuinn/PublicComputeServices) [\[Why?\]](https://github.com/kawaiiDango/pano-scrobbler/issues/876)
...
- Icons from [pictogrammers.com](https://pictogrammers.com) and [Material Symbols](https://fonts.google.com/icons)
...
Thanks to the amazing [translators](composeApp/src/commonMain/composeResources/files/crowdin_members.txt) and everyone who reported bugs and helped me with this project.
...
Pano Scrobbler ETD is licensed under the [GNU General Public License v3 or later](http://www.gnu.org/copyleft/gpl.html).
