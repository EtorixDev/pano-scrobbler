...
//            implementation(libs.core)
            ...
            implementation(libs.navigation.event.android)
...
buildkonfig {
    ...
    defaultConfigs {
        ...
        val updatesEnabledByDefault = requestedTasks.any {
            it.contains("releasegithub") || it.contains("packagenativeimage")
        }
        val updatesEnabled = localProperties.getProperty("updates.enabled")
