...
import dev.etorix.panoscrobbler.widget.WidgetPeriod
...
data class WidgetPrefs(
    ...
    data class ChartsData(
        ...
        fun canFetchAgain(refreshIntervalHours: Int) =
            System.currentTimeMillis() - fetchTime >= refreshIntervalHours.hours.inWholeMilliseconds / 2
    }
