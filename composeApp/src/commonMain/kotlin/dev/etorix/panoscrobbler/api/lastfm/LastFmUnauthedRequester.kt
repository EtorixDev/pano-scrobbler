...
import dev.etorix.panoscrobbler.api.lastfm.LastFm.Companion.toFormParametersWithSig
...
class LastFmUnauthedRequester {
    ...
    // tag
    suspend fun getTagInfo(tag: String, lang: String? = null) =
    ...
    suspend fun tagGetInfo(tag: String) = getTagInfo(tag)
