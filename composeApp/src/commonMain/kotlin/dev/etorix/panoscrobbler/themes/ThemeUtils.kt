...
import dev.etorix.panoscrobbler.themes.ContrastMode.HIGH
import dev.etorix.panoscrobbler.themes.ContrastMode.LOW
import dev.etorix.panoscrobbler.themes.ContrastMode.MEDIUM
...
object ThemeUtils {
    ...
    const val LEGACY_DEFAULT_THEME_NAME = "4385F6"
...
//        val spec = SpecVersion.SPEC_2026
    ...
    // Match the fork's blue default palette.
    const val DEFAULT_HUE = 266f
    ...
    fun legacyThemeHue(themeName: String): Float {
        val rgb = themeName.toLongOrNull(16)?.takeIf { it in 0L..0xFFFFFFL }
            ?: return DEFAULT_HUE
        return Hct.fromInt((0xFF000000L or rgb).toInt()).hue.toFloat()
    }
