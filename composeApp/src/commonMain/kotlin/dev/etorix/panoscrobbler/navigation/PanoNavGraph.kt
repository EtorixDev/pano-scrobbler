...
import dev.etorix.panoscrobbler.charts.ChartsPagerScreen
import dev.etorix.panoscrobbler.charts.RandomScreen
import dev.etorix.panoscrobbler.edits.ArtistsWithDelimitersScreen
import dev.etorix.panoscrobbler.edits.BlockedMetadatasScreen
import dev.etorix.panoscrobbler.edits.RegexEditsAddScreen
import dev.etorix.panoscrobbler.edits.RegexEditsScreen
import dev.etorix.panoscrobbler.edits.RegexEditsTestScreen
import dev.etorix.panoscrobbler.edits.SimpleEditsAddScreen
import dev.etorix.panoscrobbler.edits.SimpleEditsScreen
import dev.etorix.panoscrobbler.help.HelpScreen
import dev.etorix.panoscrobbler.help.PrivacyPolicyScreen
import dev.etorix.panoscrobbler.info.InfoPagerScreen
import dev.etorix.panoscrobbler.info.SimilarTracksScreen
import dev.etorix.panoscrobbler.main.HomePagerScreen
import dev.etorix.panoscrobbler.main.MainViewModel
import dev.etorix.panoscrobbler.onboarding.FileLoginScreen
import dev.etorix.panoscrobbler.onboarding.GnufmLoginScreen
import dev.etorix.panoscrobbler.onboarding.ListenBrainzLoginScreen
import dev.etorix.panoscrobbler.onboarding.OnboardingScreen
import dev.etorix.panoscrobbler.onboarding.OobLastfmLibrefmLoginScreen
import dev.etorix.panoscrobbler.onboarding.OobPleromaLoginScreen
import dev.etorix.panoscrobbler.onboarding.PleromaLoginScreen
import dev.etorix.panoscrobbler.onboarding.WebViewScreen
import dev.etorix.panoscrobbler.pref.AppListSaveType
import dev.etorix.panoscrobbler.pref.AppListScreen
import dev.etorix.panoscrobbler.pref.AutomationInfoScreen
import dev.etorix.panoscrobbler.pref.DeleteAccountScreen
import dev.etorix.panoscrobbler.pref.ExportScreen
import dev.etorix.panoscrobbler.pref.ImportScreen
import dev.etorix.panoscrobbler.pref.OssCreditsScreen
import dev.etorix.panoscrobbler.pref.PrefsScreen
import dev.etorix.panoscrobbler.pref.TranslatorsScreen
import dev.etorix.panoscrobbler.recents.TrackHistoryScreen
import dev.etorix.panoscrobbler.search.ImageSearchScreen
import dev.etorix.panoscrobbler.search.SearchScreen
